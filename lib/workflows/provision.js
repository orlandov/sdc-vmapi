...
var workflow = module.exports = {
     ...
     * If 'common.provisionNics' provisioned a nic that requires the use of a
     * NAT gateway then the 'fabricCommon.provisionChain' below will provision
     * the required NAT instance.
     */
    ].concat(
