...
var workflow = module.exports = {
     ...
     * If 'common.addNics' created a nic that requires the use of a NAT
     * gateway then the 'fabricCommon.provisionChain' below will provision the
     * required NAT instance.
     */
    ].concat(
    ...
    /*
     * Wait on the fabric NAT to be provisioned (if needed) before we bounce the
     * VM.
     */
    ...
    fabricCommon.releaseTicketTask, // XXX: This might be in the wrong place?
